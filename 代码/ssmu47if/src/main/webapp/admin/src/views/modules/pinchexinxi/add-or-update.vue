    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车牌" prop="chepai">
          <el-input v-model="ruleForm.chepai" 
              placeholder="车牌" clearable  :readonly="ro.chepai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车牌" prop="chepai">
              <el-input v-model="ruleForm.chepai" 
                placeholder="车牌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拼车价格" prop="pinchejiage">
          <el-input v-model="ruleForm.pinchejiage" 
              placeholder="拼车价格" clearable  :readonly="ro.pinchejiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拼车价格" prop="pinchejiage">
              <el-input v-model="ruleForm.pinchejiage" 
                placeholder="拼车价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拼车人数" prop="pincherenshu">
          <el-input v-model="ruleForm.pincherenshu" 
              placeholder="拼车人数" clearable  :readonly="ro.pincherenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拼车人数" prop="pincherenshu">
              <el-input v-model="ruleForm.pincherenshu" 
                placeholder="拼车人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          pinchejiage: [
                { required: true, message: '拼车价格不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          pincherenshu: [
                { required: true, message: '拼车人数不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          zongjiage: [
                { validator: validateIntNumber, trigger: 'blur' },
