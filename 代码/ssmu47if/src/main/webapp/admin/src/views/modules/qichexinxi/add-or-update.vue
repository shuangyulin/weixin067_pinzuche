<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="能源类型" prop="nengyuanleixing">
        ...
        <div v-else>
          <el-form-item class="input" label="能源类型" prop="nengyuanleixing">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.nengyuanleixingOptions = "汽油,电动,油电混合".split(',')
            this.zhuangtaiOptions = "待租赁,已出租".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
